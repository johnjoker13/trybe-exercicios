...
const Television_1 = __importDefault(require("./classes/Television"));
const Email_1 = __importDefault(require("./classes/Email"));
const MailList_1 = __importDefault(require("./classes/MailList"));
const televisao = new Television_1.default('Samsung', 55, '4K UHD', ['HDMI', 'Bluetooth', 'Iphone'], 'Iphone');
televisao.turnOn();
console.log(televisao.getConnectedTo);
televisao.setConnectedTo = 'Bluetooth';
console.log(televisao.getConnectedTo);
// Para testar
