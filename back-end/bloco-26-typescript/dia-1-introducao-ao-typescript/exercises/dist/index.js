...
console.log(`Losango de diagonal maior 32cm e menor 18cm: ${Exercise.losangle(32, 18)}cm²`);
console.log(`Trapézio de base maior 100cm e menor 70cm e altura 50cm: ${Exercise.trapeze(100, 70, 50)}cm² `);
